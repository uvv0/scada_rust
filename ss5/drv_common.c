...
/* HAL_Init() retains this hook; keep only its one-instruction CMSIS bridge. */
...
void rt_hw_systick_init(void)
{
    ...
    SysTick_Config((HAL_RCCEx_GetD1SysClockFreq()) / RT_TICK_PER_SECOND);
#else
...
void hw_board_init(char *clock_src, int32_t clock_src_freq, int32_t clock_target_freq)
{
    ...
    /* Ethernet-only image executes from STM32H750 internal flash. */
