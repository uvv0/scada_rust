...
|-----------|-------------|
| [ss4](ss4/) | SCADA server — Modbus poller, scheduler, scripts, PostgreSQL, MQTT |
...
| [im1](im1/) | SCADA simulator — IEC 60870-5-104 and Modbus UDP, 10000 tags |
...
- **UI**: egui (desktop), embedded web server
